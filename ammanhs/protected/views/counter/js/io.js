...
(function() {
  ...
  function getDigits() {
      ...
      values.splice(6,0,':');
      values.splice(9,0,':');
      if(days==0&&hours==0&&minutes==0&&seconds==0) document.location='http://local.ammanhs.com';
      return values;
  }
  ...
  /**
    ...
    */
  var countdownTo = new Date(2013, 4, 28, 18, 30, 00).getTime();
  //var countdownTo = new Date(2013, 4, 28, 3, 36, 00).getTime();
