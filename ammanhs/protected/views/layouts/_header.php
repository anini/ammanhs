  ...
  <div class="navbar-inner">
    <div class="container">
      ...
      <form class="navbar-search" action="/search">
        <input name="q" <?php if(isset($_GET['q'])) echo 'value="'.htmlentities($_GET['q'], ENT_QUOTES, 'UTF-8').'"'; ?> type="text" class="search-query span2" placeholder="<?php echo Yii::t('core','Search'); ?>" id="header-search" 
