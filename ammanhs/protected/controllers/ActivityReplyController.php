...
class ActivityReplyController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('ActivityReply');
	...
	{
		$this->layout='main';
		$model=new ActivityReply('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ActivityReply']))
			$model->attributes=$_GET['ActivityReply'];
	...
	{
		$model=ActivityReply::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='activity-reply-form')
		{
