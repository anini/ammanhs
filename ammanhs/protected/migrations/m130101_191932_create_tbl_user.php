	...
	public function up()
	{
		...
		try
		{
			$this->createTable('tbl_user', array(
                ...
                'stat_projects' => 'int(11) NOT NULL DEFAULT 0',
            ...
            $this->createIndex('ix_tbl_user_gender', 'tbl_user', 'gender', false);
            ...
            $this->createIndex('ix_tbl_user_country', 'tbl_user', 'country', false);
